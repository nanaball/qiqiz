	...
	public static void main(String[] args) {
		...
		menu : while(true) {
			...
			if(selectNo < 1 || 5 < selectNo) {
				...
				System.out.println("입력한 학생수는 "+studentN+" 명 입니다.");

			}else if(selectNo == 2) {
				System.out.println("1에 입력한 학생수만큼 학번, 이름, 점수를 입력해주세요 ");
				
				System.out.println("참조 객체 배열 생성자로 검색");
				System.out.println("https://blog.naver.com/lucju/222736049987");
			...
			*/
			...
			case 1 : 
				...
				System.out.println("등록할 학생 수는 : "+students.length+" 명 입니다.");
				break;
				
			case 2 :
				System.out.println("학생 정보 입력");
				// 배열에 저장될 Student 객체마다, 학번, 이름, 점수를 입력받아 저장
				// [null] [null] [null] ...
				// [Student 객체] ...
			...
			case 4 :
				...
				for(int i = 0; i < students.length; i++) {
					...
					// stuMax에 저장된 학생의 점수보다 현재 학생의 점수가 크면 stuMax에 현재 학생의 정보를 저장
					if(stuMax.score < score) {
						stuMax = students[i];						
					}
					// stuMin에 저장된 학생의 점수보다 현재 학생의 점수가 작으면 stuMin에 현재 학생의 정보를 저장
