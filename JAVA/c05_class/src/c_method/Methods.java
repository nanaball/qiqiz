...
public class Methods {
	...
	// 반환형 - return type 메소드 이름_식별자(매개변수들...){실행블럭}
	void methodA() {
		System.out.println("void 변환하는 값은 없고 매개변수 없이 기능만 수행");
	}
	...
	double methodC(int x, int y) {
		System.out.println("매개변수에 인자값 두개를 전달받아 블럭 실행 후 결과를 double type으로 반환");
		return x / y;
	}
