...
/**
 * 기본타입을 객체로 사용할 수 있도록 연산에 필요한 상수와 기능을 추가로 묶어놓은 class
 * 포장객체 - Wapper Class
 */
public class WapperExample {
	...
	public static void main(String[] args) {
		...
		// Boxing
		// new keyword는 java 9 version에서 deprecated
		Integer obj1 = null;
		...
		// valueOf 문자열 또는 기본타입의 데이터를 해당 타입의 포장객체로 반환
		...
		// valueOf == 포장객체 타입으로 변환해서 반환
		// Integer => int 자동박싱이 연산에 추가
		...
		String result0ct = Integer.toOctalString(10);
		System.out.println("result0ct : " + result0ct);
		int obj7 = Integer.parseInt(result0ct, 8);
