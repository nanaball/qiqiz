...
public class RandomExample {
	...
	public static void main(String[] args) {
		// Random Class
		// int, double boolean 의 무작위 값을 출력하는 class 객체 생성 시 
		// 생성자의 매개변수로 seed값이 결정 되며 seed 값이 일치하면 동일한 패턴으로 난수가 발생된다.
		...
		/*
		 * Math, Formatter(3개), Date, Calendar, LocalDateTime(3개), Arrays, Objects
		 */
