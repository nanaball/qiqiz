...
public class BookManagement {
	...
	public void  registerBook() {
		...
		String writer = scanLine.nextLine();
		
		Book Regist = new Book(count++, title, writer);
	...
	public void updateBook() {
		...
		int selectNo = getSelectNum("도서관리번호 입력");
		...
		System.out.println("===================================");
		selectNo = getSelectNum("수정할 번호를 입력하세요 ");
		
		 
			switch(selectNo) {
			case 1 : 
				System.out.println("제목 수정");
				int num = getSelectNum("번호입력 >");
				
				Book info = findBook(num);
				System.out.println("제목 입력 > ");
				String retitle = scanLine.nextLine();
			...
			case 2 : 
				...
				String rewriter = scanLine.nextLine();
